      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="院校名称" prop="yuanxiaomingcheng">
            <el-input v-model="ruleForm.yuanxiaomingcheng" placeholder="院校名称" clearable
              :readonly="ro.yuanxiaomingcheng"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="select" v-if="type != 'info'" label="类型" prop="leixing">
            <el-select v-model="ruleForm.leixing" placeholder="请选择类型">
              <el-option v-for="(item, index) in leixingOptions" v-bind:key="index" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="数学" prop="shuxue">
            <el-input v-model="ruleForm.shuxue" placeholder="数学" clearable :readonly="ro.shuxue"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="数学" prop="shuxue">
              <el-input v-model="ruleForm.shuxue" placeholder="数学" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="物理" prop="wuli">
            <el-input v-model="ruleForm.wuli" placeholder="物理" clearable :readonly="ro.wuli"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="物理" prop="wuli">
              <el-input v-model="ruleForm.wuli" placeholder="物理" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="化学" prop="huaxue">
            <el-input v-model="ruleForm.huaxue" placeholder="化学" clearable :readonly="ro.huaxue"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="化学" prop="huaxue">
              <el-input v-model="ruleForm.huaxue" placeholder="化学" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="生物" prop="shengwu">
            <el-input v-model="ruleForm.shengwu" placeholder="生物" clearable :readonly="ro.shengwu"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="生物" prop="shengwu">
              <el-input v-model="ruleForm.shengwu" placeholder="生物" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="信息学" prop="xinxixue">
            <el-input v-model="ruleForm.xinxixue" placeholder="信息学" clearable :readonly="ro.xinxixue"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="信息学" prop="xinxixue">
              <el-input v-model="ruleForm.xinxixue" placeholder="信息学" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="总数" prop="zongshu">
            <el-input v-model="zongshu" placeholder="总数" readonly></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.zongshu" label="总数" prop="zongshu">
              <el-input v-model="ruleForm.zongshu" placeholder="总数" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
